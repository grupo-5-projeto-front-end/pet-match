  ...
  return (
    <>
      <StyledUserPets >
        ...
        <StyledMainPerfil className="animate__fadeIn">
            ...
            <StyledDivPetPerfil>
              ...
              <div className="Content_Box">
                <div>
                  ...
                  <p>
                    <strong>Raça</strong>: {currentPet?.breed}
                  </p>
                  <p>
                    <strong>Sexo</strong>: {currentPet?.sex}
                  </p>
                  <p>
                    <strong>Idade</strong>: {currentPet?.age}
                  </p>
                </div>

                <div className="bio">
                  <p>
                    <strong>Bio</strong>: {currentPet?.bio}
                  </p>
                </div>
              </div>
            </StyledDivPetPerfil>
            ...
            <StyledDivPetPerfil>
              ...
              <div className="Content_Box">
                <div>
                  ...
                  <p>
                    <strong>Cidade</strong>: {userAndPets?.city}
                  </p>
                  <p>
                    <strong>Contato</strong>:{userAndPets?.email}
                  </p>
                  <p>
                    <strong>Telefone</strong>: {userAndPets?.tel}
                  </p>
                </div>
              </div>
            </StyledDivPetPerfil>
